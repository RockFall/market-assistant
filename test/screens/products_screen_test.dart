...
void main() {
  group('ProductsScreen Widget Tests', () {
    testWidgets('should display a grid of product cards',
    ...
    testWidgets(
        'should navigate to add product screen when add button is clicked',
        (WidgetTester tester) async {
    ...
    testWidgets('should filter products by category using dropdown',
        (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: ProductsScreen()));
